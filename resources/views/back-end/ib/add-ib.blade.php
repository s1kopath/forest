...
@section('page-content')
    <div class="card">
        ...
        <div class="card-block">
            <form action="{{ route('add_ib') }}" method="post">
                @csrf
                <div class="form-group">
                    <div class="row align-items-center">
                        <div class="col-md-2 offset-md-2">
                            <label for="" class="form-label mb-0 font-weight-bold">IB
                                Name:</label>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="row align-items-center">
                        <div class="col-md-2 offset-md-2">
                            <label for="" class="form-label mb-0 font-weight-bold">Self
                                Amount:</label>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="row align-items-center">
                        <div class="col-md-2 offset-md-2">
                            <label for="" class="form-label mb-0 font-weight-bold">Direct
                                Amount:</label>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="row align-items-center">
                        <div class="col-md-2 offset-md-2">
                            <label for="" class="form-label mb-0 font-weight-bold">Team
                                Amount:</label>
                        </div>
                        <div class="col-md-6">
