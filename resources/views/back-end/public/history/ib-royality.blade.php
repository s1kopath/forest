...
@section('page-content')
    <div class="d-flex overflow-auto pb-3" id="shihab-btn-mbl-scroll">
        ...
        <a href="{{ route('ib_royality_history') }}"><button type="button" class="btn custom-btn-active rounded-pill mx-1" id="active5" onclick="msPosition(this)">IB Royality</button></a>
    ...
    <div class="card">
        <div class="card-block">
            <div class="d-flex justify-content-between p-2">
                <h3 class="font-weight-bold">IB Royality History</h3>
                <div>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <h4 class="font-weight-bold">Daniyel001</h4>
                        ...
                        <tr>
                            ...
                            <td>
                                <h4 class="font-weight-bold">Helen999</h4>
