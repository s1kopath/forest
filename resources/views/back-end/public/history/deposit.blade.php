...
@section('page-content')
    <div class="d-flex overflow-auto pb-3" id="shihab-btn-mbl-scroll">
        <a href="{{ route('deposit_history') }}"><button type="button" class="btn custom-btn-active rounded-pill mx-1" id="active1" onclick="msPosition(this)">Deposit</button></a>
    ...
    <div class="card">
        <div class="card-block">
            <div class="d-flex justify-content-between p-2">
                <h3 class="font-weight-bold">Deposit History</h3>
                <div>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr data-toggle="collapse" data-target="#collapseExample4" class="accordion-toggle">
                            ...
                            <td>
                                <h4 class="font-weight-bold">USDT</h4>
                                <h6 >2023-01-11 14:12:09</h6>
                            </td>
                            <td class="text-right">
                                <h4 class="font-weight-bold">$100</h4>
