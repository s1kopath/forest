...
@section('page-content')
    <div class="d-flex overflow-auto pb-3" id="shihab-btn-mbl-scroll">
        ...
        <a href="{{ route('staking_roi_history') }}"><button type="button" class="btn custom-btn-active rounded-pill mx-1" id="active4" onclick="msPosition(this)">Stacking ROI</button></a>
