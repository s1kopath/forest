...
class TestController extends Controller
{
    public function test()
    {
        ...
        $payload = $timestamp . "\n" . $nonce . "\n" . $json_request . "\n";
        $binance_pay_key = "kzwhkpnVD8GF2GdvRfqcglg7BbvuRMuTbiFQb4lVxpdl9RxRUdC4Oq8tonSY8uWl";
        $binance_pay_secret = "5mFZB6YY8J1ib92XdlrIxiq8p5xpODv3mpqk3cVzT87X3OuS8PHrvToxvOn15CQ1";
